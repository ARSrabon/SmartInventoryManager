 ...
 */
@Table(name = "buyers")
public class Buyer extends SugarRecord {
    private String name;
    ...
    public Buyer(String name, String companyName, String email, String contact_Personal, String contact_Office, String address) {
        this.name = name;
